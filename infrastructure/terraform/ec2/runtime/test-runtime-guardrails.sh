...
require_literal 'RestrictAddressFamilies=AF_INET AF_UNIX' "$runtime_dir/duducar-credential-broker.service"
...
reject_literal 'AF_NETLINK' "$runtime_dir/duducar-credential-broker.service"

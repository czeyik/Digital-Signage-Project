...
require_literal 'caller-supplied -destroy' "$root_dir/recovery-terraform"
...
require_literal 'data "aws_ami" "recovery"' "$root_dir/main.tf"
require_literal 'owners      = ["amazon"]' "$root_dir/main.tf"
require_literal 'values = ["al2023-ami-2023.*-arm64"]' "$root_dir/main.tf"
require_literal 'ami                                  = data.aws_ami.recovery.id' "$root_dir/main.tf"

...
| 5 | Immutable release package, MBTiles, cost, and Terraform plan | Wave 4 | Complete | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-5-release-replay-20260829/manifest/release-manifest.json`; plan `210f353f60869f4063bd50e076c93a5ebc9a8a17b840fd9816a263408a273e39` | Rebound the corrected Wave 1 runtime renderer, revalidated immutable images/APK/MBTiles/cost, and created a fresh 0-add/2-change/0-destroy plan. No apply or activation was performed. |
| 6 | Accounts, communications, content, and launch approvals | Wave 5 | Complete | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-6-launch-replay-20260829/launch-packet.md`; evidence checksum and revalidation record beside it | Rebound the corrected Wave 5 manifest and exact unapplied plan; current account, DNS/TLS, communications, budget, content, privacy, roster, approvals, window, rollback, and one-device gates are recorded. No production deployment or enrollment performed. |
| 7 | Production infrastructure recovery and activation | Wave 6 | In progress | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-5-release-replay-20260829/manifest/release-manifest.json`; plan `210f353f60869f4063bd50e076c93a5ebc9a8a17b840fd9816a263408a273e39`; Wave 6 replay packet | Prior failed run remains audit history only. Use the fresh package/plan and new command and operation IDs; ARM and RECOVER remain just-in-time confirmations. |

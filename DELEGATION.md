...
| 5 | Immutable release package, MBTiles, cost, and Terraform plan | Wave 4 | In progress | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-5-release/manifest/release-manifest.json`; Wave 1 complete | Replaying the release package with the corrected Wave 1 runtime renderer; no apply or activation in this wave. |
| 6 | Accounts, communications, content, and launch approvals | Wave 5 | Reopened | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-6-launch/launch-packet.md`; Wave 5 reopened | The launch packet is bound to the invalidated Wave 5 manifest and must be replayed after the corrected release is approved. |
| 7 | Production infrastructure recovery and activation | Wave 6 | Blocked | SSM `a74b5117-2e97-4fdd-9b9c-4fecaed16681`; SSM `3d565a58-1269-4dd0-bc23-e2ea6fe4b5f0`; operation `54eb404f02af1eaf3545d97024395462` | Reviewed Terraform was applied and runtime/release/map assets were staged, but activation stopped before deployment because the exact release's token file is invalid. No public stack or tablet was activated. Restart from Wave 1; do not patch across the wave boundary. |

...
| 9 | Production rehearsal and one-device canary start | Wave 8 | Complete | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-9-replay-20260830/`; commit `8087380`; playlist `Test` v12 | AWS–GCP WIF is active; production readiness, DNS/TLS, privacy/authentication, private media, backups/alarms/budget, OpenMapTiles/GPS, and the isolated EventBridge/SNS failure path passed. Exactly one approved Lenovo `HA259E36` is active on code 4 with one credential, fresh GPS, and accepted v12 playback. Canary started at `2026-08-30 05:45:56.939 MYT` and runs through `2026-08-31 05:45:56.939 MYT`; optional waived exercises were not repeated. |
...
| 2026-08-30 05:45:56.939 | 9 | Complete | `8087380` / `4.0.1` code `4`; `Test` v12 | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-9-replay-20260830/`; final readiness SSM; device readback | Owner-authorized WIF-backed production decoder, exact code-4 deployment, one-device enrollment, fresh GPS, accepted v12 playback, and EventBridge/SNS failure delivery passed. A delivered-image-dimension defect was corrected by owner-publishing v12 with the valid MP4; no optional waived exercise was repeated. The 24-hour canary starts at `05:45:56.939 MYT` and ends at `2026-08-31 05:45:56.939 MYT`; Wave 10 remains Waiting. |

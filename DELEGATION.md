...
| 7 | Production infrastructure recovery and activation | Wave 6 | In progress | `/home/czeyik/.local/share/Cryptomator/mnt/dspvault/duducar-signing/wave-5-release-replay-20260829-r2/manifest/release-manifest.json`; plan `0bf954d82c33ff3dc63157a26e1d5e1ef71c1c785c422215f89728ff2a583c92`; Wave 6 r2 replay packet | Prior failed run and stale r1 plan remain audit history only. Use the fresh r2 package/plan and new command and operation IDs; ARM and RECOVER remain just-in-time confirmations. |
